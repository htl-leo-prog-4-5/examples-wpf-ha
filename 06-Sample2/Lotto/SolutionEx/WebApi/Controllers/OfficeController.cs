...
public class OfficeController : ControllerBase
{
    ...
    public record OfficeDto(int Id, string No, string Name, string Address, string? city, string? plz, string? street, string? streetNo, int? stateId);
    ...
    OfficeDto? ToDto(Office? entity)
    {
        ...
        return new OfficeDto(entity.Id, entity.No, entity.Name, entity.Address, entity.City, entity.PLZ, entity.Street, entity.StreetNo, entity.StateId);
    }
