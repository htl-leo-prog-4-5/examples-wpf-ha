...
public class MainViewModelTests
{
    ...
    public async Task LoadDataTest()
    {
        ...
        var uow            = Substitute.For<IUnitOfWork>();
        var gameRepository = Substitute.For<IRouteRepository>();
/*
        uow.GameRepository.Returns(gameRepository);

        var games = new CsvImport<Ship>().Read(
            """
        ...
        uow.GameRepository.GetNoTrackingAsync(Arg.Any<Expression<Func<Ship, bool>>>(),
