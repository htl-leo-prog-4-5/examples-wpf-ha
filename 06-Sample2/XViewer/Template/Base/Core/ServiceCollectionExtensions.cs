...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAssemblyIncludingInternals(this IServiceCollection services,
        ServiceLifetime liveTime, params Assembly[] assemblies)
    {
    ...
    public static IServiceCollection AddAssemblyByName(this IServiceCollection services, Func<string, bool> checkName,
        ServiceLifetime liveTime, params Assembly[] assemblies)
    {
        foreach (var assembly in assemblies)
        {
