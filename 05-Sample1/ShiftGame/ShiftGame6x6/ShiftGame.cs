...
namespace ShiftGame6x6
{
    public class ShiftGame : ShiftGameBase
    {
        ...
        public string Field05 => Field[0, 5];
        ...
        public string Field15 => Field[1, 5];
        ...
        public string Field25 => Field[2, 5];
        ...
        public string Field35 => Field[3, 5];
        ...
        public string Field45 => Field[4, 5];

        public string Field50 => Field[5, 0];
        public string Field51 => Field[5, 1];
        public string Field52 => Field[5, 2];
        public string Field53 => Field[5, 3];
        public string Field54 => Field[5, 4];
        public string Field55 => Field[5, 5];
        ...
        public ICommand SetField05Command => new DelegateCommand(() => { SetField(0, 5); }, () => CanSetField(0, 5));
        ...
        public ICommand SetField15Command => new DelegateCommand(() => { SetField(1, 5); }, () => CanSetField(1, 5));
        ...
        public ICommand SetField25Command => new DelegateCommand(() => { SetField(2, 5); }, () => CanSetField(2, 5));
        ...
        public ICommand SetField35Command => new DelegateCommand(() => { SetField(3, 5); }, () => CanSetField(3, 5));
        ...
        public ICommand SetField45Command => new DelegateCommand(() => { SetField(4, 5); }, () => CanSetField(4, 5));

        public ICommand SetField50Command => new DelegateCommand(() => { SetField(5, 0); }, () => CanSetField(5, 0));
        public ICommand SetField51Command => new DelegateCommand(() => { SetField(5, 1); }, () => CanSetField(5, 1));
        public ICommand SetField52Command => new DelegateCommand(() => { SetField(5, 2); }, () => CanSetField(5, 2));
        public ICommand SetField53Command => new DelegateCommand(() => { SetField(5, 3); }, () => CanSetField(5, 3));
        public ICommand SetField54Command => new DelegateCommand(() => { SetField(5, 4); }, () => CanSetField(5, 4));
        public ICommand SetField55Command => new DelegateCommand(() => { SetField(5, 5); }, () => CanSetField(5, 5));
